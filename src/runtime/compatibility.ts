...
export const PROMPT_ENGINE_M8_CONTRACT_VERSION = "0.0";
export const PROMPT_ENGINE_M8_CONTRACT = `${PROMPT_ENGINE_M8_CONTRACT_ID}@${PROMPT_ENGINE_M8_CONTRACT_VERSION}` as const;
export const PROMPT_ENGINE_M8_TESTED_SERVICE_VERSION = "0.0.1";
export const PROMPT_ENGINE_M8_MIN_SERVICE_VERSION = "0.0.1";
export const PROMPT_ENGINE_M8_MAX_SERVICE_VERSION_EXCLUSIVE = "0.1.0";
